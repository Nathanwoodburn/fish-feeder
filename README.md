...
3D Files are avaliable as [stl](https://www.thingiverse.com/thing:4821940) or [Fusion 360 files](https://ql.nathan3dprint.tk/fish) if using this model you also need a film canistor to hold the fish food.
